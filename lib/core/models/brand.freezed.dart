...
@JsonKey(name: 'brand_id') int get id; String get name; String? get slug;
...
@useResult
$Res call({
@JsonKey(name: 'brand_id') int id, String name, String? slug
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'brand_id')  int id,  String name,  String? slug)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Brand() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'brand_id')  int id,  String name,  String? slug)  $default,) {final _that = this;
switch (_that) {
case _Brand():
return $default(_that.id,_that.name,_that.slug);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'brand_id')  int id,  String name,  String? slug)?  $default,) {final _that = this;
switch (_that) {
case _Brand() when $default != null:
return $default(_that.id,_that.name,_that.slug);case _:
  return null;
...
class _Brand implements Brand {
  const _Brand({@JsonKey(name: 'brand_id') required this.id, required this.name, this.slug});
  factory _Brand.fromJson(Map<String, dynamic> json) => _$BrandFromJson(json);

@override@JsonKey(name: 'brand_id') final  int id;
